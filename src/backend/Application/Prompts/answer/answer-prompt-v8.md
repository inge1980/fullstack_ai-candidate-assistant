...
In Norwegian answers, keep project titles unchanged. Extra-link labels: live stays live demo; portfolio is artikkel i portef�lje; GitHub stays GitHub repo.
...
Treat the list as an intersection when the question uses language such as both, together, in the same project, the same project, used ... with ..., b�de, samme prosjekt, or i samme prosjekt. "Have you used A and B" and "Har du brukt A og B" are also intersections: only include projects that used every named technology.
